...
#define DtoC (kOpFlagRealToComplex)
	const OpInfo mpOpInfo[kOpCount] = {
	  ...
	  OpInfo("floor", kOpFloor, 0, LTR | DtoD | kOpFlagRounding | kOpFlagUnary | kOpFlagIntrinsic, mpFloor, nullptr),
	  OpInfo("ceil", kOpCeil, 0, LTR | DtoD | kOpFlagRounding | kOpFlagUnary | kOpFlagIntrinsic, mpCeil, nullptr),
	  OpInfo("abs", kOpAbs, 0, LTR | DtoD | CtoD | kOpFlagUnary | kOpFlagIntrinsic, mpAbs, nullptr, mpAbsC, nullptr),
	  OpInfo("exp", kOpExp, 0, LTR | CandD | kOpFlagUnary | kOpFlagIntrinsic, mpExp, mpFuncCtoC1<std::exp>),
	  OpInfo("log", kOpLog, 0, LTR | CandD | kOpFlagUnary | kOpFlagIntrinsic, mpLog, mpFuncCtoC1<std::log>),
	  OpInfo("log2", kOpLog2, 0, LTR | CandD | kOpFlagUnary | kOpFlagIntrinsic, mpLog2, mpLog2C),
	  OpInfo("log10", kOpLog10, 0, LTR | CandD | kOpFlagUnary | kOpFlagIntrinsic, mpLog10, mpFuncCtoC1<std::log10>),
	  OpInfo("sqrt", kOpSqrt, 0, LTR | DtoD | kOpFlagUnary | kOpFlagIntrinsic, mpSqrt, nullptr),
	  OpInfo("frac", kOpFrac, 0, LTR | DtoD | kOpFlagUnary | kOpFlagIntrinsic, mpFrac, nullptr),
	  OpInfo("recip", kOpRecip, 0, LTR | CandD | kOpFlagUnary | kOpFlagIntrinsic, mpRecip, mpRecipC),
	  OpInfo("sin", kOpSin, 0, LTR | CandD | kOpFlagTrigonometric | kOpFlagUnary | kOpFlagIntrinsic, mpSin, mpFuncCtoC1<std::sin>),
	  OpInfo("cos", kOpCos, 0, LTR | CandD | kOpFlagTrigonometric | kOpFlagUnary | kOpFlagIntrinsic, mpCos, mpFuncCtoC1<std::cos>),
	  OpInfo("tan", kOpTan, 0, LTR | CandD | kOpFlagTrigonometric | kOpFlagUnary | kOpFlagIntrinsic, mpTan, mpFuncCtoC1<std::tan>),
	  OpInfo("sinh", kOpSinh, 0, LTR | CandD | kOpFlagTrigonometric | kOpFlagUnary | kOpFlagIntrinsic, mpSinh, mpFuncCtoC1<std::sinh>),
	  OpInfo("cosh", kOpCosh, 0, LTR | CandD | kOpFlagTrigonometric | kOpFlagUnary | kOpFlagIntrinsic, mpCosh, mpFuncCtoC1<std::cosh>),
	  OpInfo("tanh", kOpTanh, 0, LTR | CandD | kOpFlagTrigonometric | kOpFlagUnary | kOpFlagIntrinsic, mpTanh, mpFuncCtoC1<std::tanh>),
	  OpInfo("asin", kOpAsin, 0, LTR | CandD | kOpFlagTrigonometric | kOpFlagUnary | kOpFlagIntrinsic, mpAsin, mpFuncCtoC1<std::asin>),
	  OpInfo("acos", kOpAcos, 0, LTR | CandD | kOpFlagTrigonometric | kOpFlagUnary | kOpFlagIntrinsic, mpAcos, mpFuncCtoC1<std::acos>),
	  OpInfo("atan", kOpAtan, 0, LTR | CandD | kOpFlagTrigonometric | kOpFlagUnary | kOpFlagIntrinsic, mpAtan, mpFuncCtoC1<std::atan>),
	  OpInfo("avg", kOpAvg, 0, LTR | CandD | kOpFlagBinary | kOpFlagIntrinsic, mpAvg, mpAvgC),
	  OpInfo("min", kOpMin, 0, LTR | DtoD | kOpFlagBinary | kOpFlagIntrinsic, mpMin<double>, nullptr),
	  OpInfo("max", kOpMax, 0, LTR | DtoD | kOpFlagBinary | kOpFlagIntrinsic, mpMax<double>, nullptr),
	  OpInfo("pow", kOpPow, 0, LTR | CandD | kOpFlagBinary | kOpFlagNopIfROne | kOpFlagIntrinsic, mpPow, mpFuncCtoC2<std::pow>),
	  OpInfo("atan2", kOpAtan2, 0, LTR | DtoD | kOpFlagTrigonometric | kOpFlagBinary | kOpFlagIntrinsic, mpAtan2, nullptr),
	  OpInfo("hypot", kOpHypot, 0, LTR | DtoD | kOpFlagTrigonometric | kOpFlagBinary | kOpFlagIntrinsic, mpHypot, nullptr),
	  OpInfo("copysign", kOpCopySign, 0, LTR | DtoD | kOpFlagBinary | kOpFlagIntrinsic, mpCopySign, nullptr),
	  ...
	  OpInfo("conjug", kOpConjug, 0, LTR | CtoC | kOpFlagUnary | kOpFlagIntrinsic, nullptr, mpFuncCtoC1<std::conj>),
	  OpInfo("sqrtC", kOpSqrtC, 0, LTR | CtoC | kOpFlagUnary | kOpFlagIntrinsic, nullptr, mpFuncCtoC1<std::sqrt>)
	};

	std::map<std::string, OpInfo> symbols_ = {
		{"-", OpInfo("-", kOpNeg, 3, RTL | CandD | kOpFlagArithmetic | kOpFlagUnary)},
		{"!", OpInfo("!", kOpNot, 3, RTL | DtoD | kOpFlagCondition | kOpFlagUnary)},
		...
		{"conjug", OpInfo("conjug", kOpConjug, 0, LTR | CtoC | kOpFlagUnary)},
