...
namespace mathpresso
{
	...
	//! \internal
	static uintptr_t mpAtomicGet(const uintptr_t* atomic)
	{
		return *(const uintptr_t volatile*)atomic;
	}

	//! \internal
	static void mpAtomicSet(uintptr_t* atomic, size_t value)
	{
...
# if defined(__x86_64__) || defined(_WIN64) || defined(_M_IA64) || defined(_M_X64)
	//! \internal
	static uintptr_t mpAtomicSetXchg(uintptr_t* atomic, uintptr_t value)
	{
		return _InterlockedExchange64((__int64 volatile *)atomic, static_cast<__int64>(value));
	};
	//! \internal
	static uintptr_t mpAtomicInc(uintptr_t* atomic)
	{
		return _InterlockedIncrement64((__int64 volatile *)atomic);
	};
	//! \internal
	static uintptr_t mpAtomicDec(uintptr_t* atomic)
	{
...
# endif // _64BIT
	...
	template<typename T>
	T mpAtomicSetXchgT(T* atomic, T value)
	{
